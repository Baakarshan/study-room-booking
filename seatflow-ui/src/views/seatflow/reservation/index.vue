  ...
  <div class="app-container booking-page">
    ...
    <el-card shadow="never" class="filter-card">
      ...
      <el-form :model="query" label-position="top" class="selector-grid">
        ...
        <el-form-item label="预约时间" class="time-field"><div class="time-picker-row"><el-date-picker v-model="timeRange" type="datetimerange" start-placeholder="开始时间" end-placeholder="结束时间" value-format="YYYY-MM-DD HH:mm:ss" format="YYYY-MM-DD HH:mm" :disabled-date="disablePastDate" /><el-button plain @click="useTomorrowMorning">明天 10:00-11:00</el-button></div></el-form-item>
